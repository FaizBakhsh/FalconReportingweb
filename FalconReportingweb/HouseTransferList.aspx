<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HouseTransferList.aspx.cs" Inherits="FalconReportingweb.HouseTransferList" %>
...
<head runat="server">
    <title>House Transfer Report</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="row">
            ...
            <LocalReport ReportPath="Reports\HouseTransferRpt.rdlc" EnableExternalImages="True" EnableHyperlinks="True">
            </LocalReport>
        </rsweb:ReportViewer>
            </div>
            <div class="col-md-3">
